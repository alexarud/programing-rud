...
/**
 * @brief Зчитує одну вакансію з файлу (наступний непорожній рядок).
 * @param f Вхідний файл.
 * @param v Вказівник на вакансію для заповнення.
 * @return 1 якщо вакансію зчитано, 0 у разі кінця файлу.
 */
int vacancy_read_one(FILE *f, Vacancy *v);

/**
 * @brief Записує вакансію у файл за допомогою fprintf.
